Public Class Form1
    ...
    Private Sub cbPreview_CheckedChanged(sender As Object, e As EventArgs) Handles cbPreview.CheckedChanged, cbPreview.Click
    ...
    Private Sub AboutToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AboutToolStripMenuItem.Click
        MsgBox("Wallpaper Changer v1.0 " & vbCrLf & "Created by Antonius Rachmat C" & vbCrLf & "milka.putri@ti.ukdw.ac.id")
    End Sub
