Public Class frmHistogram
    Private Sub frmHistogram_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim bmp = New Bitmap(frmUtama.pbGambar.Image)
        ...
        For i As Integer = 0 To 255
            ...
            frekB(i) = 0
        Next
        For bar As Integer = 1 To frmUtama.pbGambar.Image.Height - 2
            For kol As Integer = 1 To frmUtama.pbGambar.Image.Width - 2
